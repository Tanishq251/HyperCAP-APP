    ...
    <>
      ...
      <section className="main-section">
        ...
        <div className="project-buttons">
          <a href="https://github.com/your-repo-link" className="project-btn" target="_blank" rel="noreferrer">Paper</a>
          <a href="https://github.com/arya-domain/HyperCap" className="project-btn" target="_blank" rel="noreferrer">Code</a>
          <a href="/bibtex.txt" className="project-btn" download>BibTeX</a>
        </div>
          ...
          {authors.map((author, index) => (
            <div className="author-hovercard" key={index}>
              ...
              <div className="hovercard">
                ...
                {author.email && <p><a href={`mailto:${author.email}`}>{author.email}</a></p>}
                {author.scholar && <p><a href={author.scholar} target="_blank" rel="noreferrer">Google Scholar</a></p>}
                {author.dblp && <p><a href={author.dblp} target="_blank" rel="noreferrer">DBLP</a></p>}
                {author.linkedin && <p><a href={author.linkedin} target="_blank" rel="noreferrer">LinkedIn</a></p>}
                {author.github && <p><a href={author.github} target="_blank" rel="noreferrer">GitHub</a></p>}
                {author.website && <p><a href={author.website} target="_blank" rel="noreferrer">Website</a></p>}
              </div>
      ...
      <section className="highlights-section">
        ...
        <ul className="highlight-list">
          <li>We propose <strong>HyperCap</strong>, the first large-scale HSI captioning dataset for Remote Sensing, providing fine-grained, pixel-wise textual descriptions for HSI images.</li>
          <li> Unlike traditional HSI datasets that focus solely on classification, HyperCap combines spectral data with textual annotations. This integration allows models to generate human-readable explanations, thereby enhancing semantic understanding.</li>
          <li>We evaluate the effectiveness of existing methods on HyperCap, establishing a foundation for future research in vision-language learning for HSI imaging.</li>
        </ul>
      </section>
    </>
  );
